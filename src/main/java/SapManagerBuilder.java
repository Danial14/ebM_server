...
public class SapManagerBuilder {
    ...
    public synchronized SapManager build(String createDestinationFileName) throws JCoException, IOException {
        ...
        JCoDestination jCoDestination = JCoDestinationManager.getDestination(createDestinationFileName);
        System.out.println(jCoDestination.getAttributes());
        return new SapManager(jCoDestination);
    }
